...
![Confluent Badge](https://images.ctfassets.net/gt6dp23g0g38/3Aw4iK55rtf1jIfQmnX7YD/4e1e54026c7e9cb2a5b67bf6c36fa4c9/Data_Streaming_Engineer_Badge.png)
...
- Handling **late events** in Flink with watermarks  
...
- Flink DataStream jobs with keyed state, event-time windows, and savepoints  
...
- Flink **state handling** and late-event processing  
...
Scoring **100% on Kafka, Kafka Connect, and Kafka Streams**, I feel confident in my streaming knowledge, and I’m excited to **grow further in Flink and Schema Registry**.  
